...
L'analyse de l'autocorrélogramme, conjointement avec l'autocorrélogramme partiel ne nous permet pas de conclure à un modèle AR ou à un modèle MA. Nous testons alors les modèles ARMA(p,q) avec pmax = 5, qmax = 2 et les critères AIC et BIC poru la sélection du modèle.
